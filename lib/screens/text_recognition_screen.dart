...
class _TextRecognitionScreenState extends State<TextRecognitionScreen> {
  final CollectionReference _textos = FirebaseFirestore.instance.collection("textos");
  ...
  void getTextFromImage(XFile image) async {
    try {
      ...
      _textos.add({"text": result}); // Use 'await' para aguardar a conclusão da operação.
      isScanning = false;
      await textDetector.close();
      setState(() {});
    } catch (e) {
      print("Erro ao adicionar ao Firestore: $e");
    }
  }
